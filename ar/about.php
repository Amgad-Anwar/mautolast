    ...
    <div class="container">
        <div class="row text-center intro-title">
            <div class="col-md-6 text-md-start d-inline-block">
                <h1 class="text-white">عن الشركه </h1>
            </div>
...
<section class="welcome-4 page-section-ptb white-bg">
    <div class="container">
        ...
        <div class="row">
            ...
            <div style="text-align: right !important;" class="col-md-6">
                <p>Dealer obcaecati adipisci vero lorem ipsum dolor sit amet, consectetur adipisicing elit. dolorum
                    pariatur aut consectetur. Sit quisquam rerum corporis neque atque inventore nulla, quibusdam, ipsa
                    suscipit aperiam reiciendis, ea odio?</p>
                <br/>
                <p>Adipisicing ipsum dolor sit amet, consectetur elit. Obcaecati adipisci vero dolorum pariatur aut
                    consectetur. Sit quisquam rerum corporis neque atque inventore nulla, quibusdam, ipsa suscipit
                    aperiam reiciendis, ea odio?</p>
                <p>Obcaecati adipisci vero dolorum pariatur aut consectetur. lorem ipsum dolor sit amet, consectetur
                    adipisicing elit. Sit quisquam rerum corporis neque atque inventore nulla, quibusdam, ipsa suscipit
                    aperiam reiciendis, ea odio?</p>
            </div>
            <div class="col-md-6">
                <div class="owl-carousel owl-theme" data-nav-arrow="true" data-items="1" data-md-items="1"
                    ...
                    <div class="item">
                        <img class="img-fluid" src="assets/images/car/15.jpg" alt="">
                    </div>
                    <div class="item">
                        <img class="img-fluid" src="assets/images/car/16.jpg" alt="">
                    </div>
                    <div class="item">
                        <img class="img-fluid" src="assets/images/car/17.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <ul class="timeline list-style-none">
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body">
                                <p>From the beginning lorem ipsum dolor sit amet, consectetur sed do eiusmod tempor
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body">
                                <p>We own our own New Service Garage incididunt Lorem ipsum dolor sit amet consectetur
                                    adipiscing elit.</p>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body">
                                <p>With new super cool office elit lorem ipsum dolor sit amet sed do eiusmod tempor
                                    incididunt ut labore.</p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body">
                                <p>Start online business tempor lorem ipsum dolor sit amet, consectetur adipiscing elit
                                    incididunt ut labore.</p>
                            </div>
                        </div>
                    </li>
