...
?>
    ...
    <section style="direction: rtl" class="car-details page-section-ptb">
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <h3><?= $car['name'] ?> </h3>
                ...
                <div class="col-md-3">
                    <div class="car-price text-md-end">
                        ...
                        <span>مضاف اليه الضريبه والرخصه</span>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <ul>
                            <li>
                                <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    <i class="fa fa-question-circle"></i> المزيد من المعلومات
                                </a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="exampleModalLabel">المزيد من المعلومات </h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p class="sub-title">برجاء كتابه بياناتك ليتم التواصل معك </p>
                                                <form class="gray-form reset_css" id="rmi_form" method="post"
                                                      action="<?=URL?>ar/car-details.php?id=<?= $car['id'] ?>">
                                                    ...
                                                    <div>
                                                        <button class="button red" name="submit" type="submit" id="request_more_info_submit">ارسال <i
                            ...
                            <li><a href="javascript:window.print()"><i class="fa fa-print"></i>  طباعه الصفحه </a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="car-details-sidebar">
                        <div class="details-block details-weight">
                            <h5>التفاصيل</h5>
                            <ul>
                                <li><span>المصنع</span> <strong class="text-end"><?= $car['make'] ?></strong></li>
                                <li><span>الموديل</span> <strong class="text-end"><?= $car['model'] ?></strong></li>
                                <li><span>سنه الانشاء </span> <strong class="text-end"><?= $car['registration_date'] ?></strong></li>
                                <li><span>عدد الميلات</span> <strong class="text-end"><?= $car['mileage'] ?></strong></li>
                                <li><span>الشروط</span> <strong class="text-end"><?= $car['con'] ?></strong></li>
                                <li><span>اللون الخارجي</span> <strong class="text-end"><?= $car['exterior_color'] ?></strong></li>
                                <li><span>اللون الداخلي </span> <strong class="text-end"><?= $car['interior_color'] ?></strong></li>
                                <li><span>نظام الدفع</span> <strong class="text-end"><?= $car['drivetrain'] ?></strong></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item icon-diamond" role="presentation">
                                <button class="nav-link active" id="general-information-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="general-information" aria-selected="true">معلومات عامه
                                </button>
                            </li>
                            <li class="nav-item icon-equalizer" role="presentation">
                                <button class="nav-link " id="vehicle-overview-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="vehicle-overview" aria-selected="false">معلومات عن السياره
                                </button>
                            </li>
                        </ul>
