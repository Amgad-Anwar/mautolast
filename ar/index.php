            ...
            <ul>  <!-- SLIDE  -->
                <li data-index="rs-5" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 6;font-size: 70px; line-height: 70px; font-weight: 700; color: rgba(255, 255, 255, 1.00);text-align:center;">
                        مكاوي للسيارات
                    </div>
                    ...
                    <div class="tp-caption button red tp-resizeme"
                         ...
                         style="z-index: 7; white-space: nowrap; font-size: 14px; line-height: 18px; font-weight: 400; color: rgba(255, 255, 255, 1.00);font-family:'cairo';text-align:center;text-transform:uppercase;background-color:rgba(219, 45, 46, 1.00);padding:12px 20px 12px 20px;border-color:rgba(0, 0, 0, 1.00);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">
                        اعرف المزيد
                    </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="price-slide">
                        <div class="price">
                            <label class="form-label" for="amount">متوسط السعر</label>
                            <input type="text" id="amount" class="amount" value="$50 - $300"/>
                            <div id="slider-range"></div>
                            <a class="button" href="#">ابحث الان</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title">
                    <span>مرحبا فى موقعنا</span>
                    <h2>مكاوي للسيارات</h2>
                    ...
                    <div class="item">
                        <div class="car-item text-center">
                            ...
                            <div class="car-content">
                                ...
                                <div class="separator"></div>
                                <div class="price">
                                    <h5 class="new-price">EGP 32,698 </h5>
                                </div>
                                <div>
                                    <ul class="list-inline">
                                        ...
                                        <li class="row">
                                            ...
                                            <strong class="col-xs-6">Suzuki</strong>
                                        </li>
                                        <br>
                                        <li class="row">
                                            <span class="col-xs-6">Model</span>
                                            <strong class="col-xs-6">Camaro</strong>
                                        </li>
                                        <br>
                                        <li class="row">
                                            <span class="col-xs-6">Body Style</span>
                                            <strong class="col-xs-6">Crossover</strong>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div style="direction: rtl" class="row">
                ...
                <div class="col-md-6">
                    <div class="blog-content">
                        <a class="link" href="#">Porsche 911 is text of the printin a galley of type and bled it to make
                            a type specimen book. </a>
