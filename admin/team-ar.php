                        ...
                        <div class="card">
                            <div class="row">
                                ...
                                <div class="col-md-6 p-0">
                                    ...
                                    <a class="btn btn-primary" href="teamcreate-ar.php"> <i data-feather="plus-square"> </i>Create New member</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4 box-col-4">
                        <div class="card custom-card">
                            ...
                            <div style="text-align: center">
                                <a href="<?=URL ?>admin/teamedite-ar.php?id=<?=$team['id']?>" class="btn btn-primary">Edit</a>
                                <a href="<?=URL ?>admin/handlers/deleteteam-ar.php?id=<?= $team['id'] ?>" class="btn btn-danger">Delete</a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
