                                                            ...
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="post" action="<?= URL?>admin/handlers/createcategory.php" class="form-bookmark needs-validation"
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <a href="<?=URL?>admin/handlers/deletecategory.php?id=<?= $category['id'] ?>" class="btn btn-danger">
                                                                                            Delete
                                                                                        </a>
                                                                                    </td>
                                                                                </tr>
