                        ...
                        <ul class="sidebar-links" id="simple-bar">
                            ...
                            <li class="sidebar-list">
                                ...
                                <ul class="sidebar-submenu">
                                    <li><a class="submenu-title" href="#">Team<span class="sub-arrow"><i
                                                    class="fa fa-angle-right"></i></span></a>
                                        <ul class="nav-sub-childmenu submenu-content">
                                            <li><a href="teamcreate.php">Create New</a></li>
                                            <li><a href="team.php">Team List</a></li>
                                        </ul>
                                    </li>
                                    <li><a class="submenu-title" href="#">Cars<span class="sub-arrow"><i
                                                        class="fa fa-angle-right"></i></span></a>
                                        <ul class="nav-sub-childmenu submenu-content">
                                            <li><a href="carcreate.php">Create New</a></li>
                                            <li><a href="car.php">Cars List</a></li>
                                        </ul>
                                    </li>
                                    <li><a class="submenu-title" href="#">Blog<span class="sub-arrow"><i
                                        ...
                                        <ul class="nav-sub-childmenu submenu-content">
                                            ...
                                            <li><a href="blogcategory.php">Blog Category</a></li>
                                        </ul>
                                    </li>
                                    <li><a class="submenu-title" href="#">Service<span class="sub-arrow"><i
                                                    class="fa fa-angle-right"></i></span></a>
                                        <ul class="nav-sub-childmenu submenu-content">
                                            <li><a href="servicecreate.php">Create New</a></li>
                                            <li><a href="service.php">Service List</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            <li class="sidebar-list">
                                ...
                                <ul class="sidebar-submenu">
                                    <li><a class="submenu-title" href="#">Team<span class="sub-arrow"><i
                                                        class="fa fa-angle-right"></i></span></a>
                                        <ul class="nav-sub-childmenu submenu-content">
                                            <li><a href="teamcreate-ar.php">Create New</a></li>
                                            <li><a href="team-ar.php">Team List</a></li>
                                        </ul>
                                    </li>
                                    <li><a class="submenu-title" href="#">Cars<span class="sub-arrow"><i
                                                        class="fa fa-angle-right"></i></span></a>
                                        <ul class="nav-sub-childmenu submenu-content">
                                            <li><a href="carcreate-ar.php">Create New</a></li>
                                            <li><a href="car-ar.php">Cars List</a></li>
                                        </ul>
                                    </li>
                                    <li><a class="submenu-title" href="#">Blog<span class="sub-arrow"><i
                                                        class="fa fa-angle-right"></i></span></a>
                                        <ul class="nav-sub-childmenu submenu-content">
                                            <li><a href="blogcreate-ar.php">Create New</a></li>
                                            <li><a href="blog-ar.php">Blog List</a></li>
                                            <li><a href="blogcategory-ar.php">Blog Category</a></li>
                                        </ul>
                                    </li>
                                    <li><a class="submenu-title" href="#">Service<span class="sub-arrow"><i
                                                        class="fa fa-angle-right"></i></span></a>
                                        <ul class="nav-sub-childmenu submenu-content">
                                            <li><a href="servicecreate-ar.php">Create New</a></li>
                                            <li><a href="service-ar.php">Service List</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="requested-orders.php">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="requested-cars.php">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <g>
