                        ...
                        <div class="card">
                            <div class="row">
                                ...
                                <div class="col-md-6 p-0">
                                    ...
                                    <a class="btn btn-primary" href="blogcreate-ar.php"> <i
                                        ...
                                        <div class="col-xl-7 col-12">
                                            <div class="blog-details">
                                                ...
                                                <div class="blog-bottom-content">
                                                    ...
                                                    <hr>
                                                    <div>
                                                        <a href="<?=URL ?>admin/blogedit-ar.php?id=<?=$blog['id']?>" class="btn btn-primary">Edit</a>
                                                        <a href="<?=URL ?>admin/handlers/deleteblog-ar.php?id=<?=$blog['id']?>" class="btn btn-danger">Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
